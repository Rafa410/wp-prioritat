						...
						<ul class="social-icons d-inline-flex list-unstyled mb-0 gap-2">
							...
							<li>
								<a class="icon icon-facebook p-2 rounded-circle" href="https://facebook.com/" title="Facebook" target="_blank" rel="noopener noreferrer">
									...
									<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
							...
							<li>
								<a class="icon icon-twitter p-2 rounded-circle" href="https://twitter.com/prioritat" title="Twitter" target="_blank" rel="noopener noreferrer">
									...
									<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
							...
							<li>
								<a class="icon icon-youtube p-2 rounded-circle" href="https://youtube.com/" title="youtube" target="_blank" rel="noopener noreferrer">
									...
									<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-youtube" viewBox="0 0 16 16">
