	...
	*/
	...
	(function ($) {
	  ...
	  $(function () {
	    ...
	    const $searchform = $('.searchform-post, .searchform-noticies, .searchform-agenda_events').children('.search-form');
	  ...
	  function ajaxSearch(data, $postsList) {
	    ...
	    $.ajax({
	      ...
	      // Show results
	      $postsList.html(data); // TODO: Pass filters to search query
	      // // Filter results
	      ...
	      window.location.hash = 'resultats-cerca'; // Remove input focus

	      $('.searchform-post, .searchform-noticies, .searchform-agenda_events').find('.search-field').blur();
	    }).fail(function () {
